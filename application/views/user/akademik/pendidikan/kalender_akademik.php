        ...
        <div class="row">
            <div class="col-lg-8 md-mb-50">
                ...
                <p style="text-align: justify">
                    Program Studi Informatika dalam aktifitas akademik berkesesuaian dengan kegiatan akademik Universitas Bahaudhin Mudhary Madura. Meliputi kegiatan baik semester ganjil maupun semester genap dalam setiap tahun akademik.
                    <?= $blog['deskripsi_blog'] ?>
                </p>
                <?php if ($blog['file_blog'] != '') : ?>
                    <div class="services-img">
                        ...
                        <?php else : ?>
                            <img src="<?= base_url('assets/foto/upload/') . $blog['file_blog'] ?>" width="100%" alt="">
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
